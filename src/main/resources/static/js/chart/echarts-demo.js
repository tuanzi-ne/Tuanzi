$(function () {
    ...
    var categoryChart = echarts.init(document.getElementById("echarts-category-chart"));
    var categoryoption = getCgOption();
    categoryChart.setOption(categoryoption);
    $(window).resize(categoryChart.resize);
    ...
    var funneloption = getFunnelOption();
...
function getForceOption() {
    var option ={
        ...
        toolbox: {
            ...
            feature : {
                restore : {show: true},
                magicType: {show: true, type: ['force', 'category']},
                saveAsImage : {show: true}
            }
        },
        legend: {
